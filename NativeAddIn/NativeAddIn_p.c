...
/* Object interface: IConnect, ver. 0.0,
   GUID={0x536F896B,0x6A01,0x426E,{0x88,0x83,0xA7,0xB7,0x0D,0xD5,0x16,0xFF}} */
...
/* Object interface: IRibbonCallback, ver. 0.0,
   GUID={0x9ADEC42E,0x0687,0x4377,{0xAD,0x70,0x5D,0x9F,0x81,0x02,0xF6,0x77}} */
...
int __stdcall _NativeAddIn_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _NativeAddIn, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _NativeAddIn, 2, *pIndex )
